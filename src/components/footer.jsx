    ...
    <footer className="footer">
        <div className="footer-content">
            ...
            <div className="footer-icons">
                <a href="https://www.facebook.com/luis.ramos.guz" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.instagram.com/lucho_adr_/" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://x.com/LuchoGGEZ" target="_blank" rel="noopener noreferrer">
